...
$ac = "";
if(isset($_GET['action'])){$ac = $_GET['action'];}
...
if(isset($_GET['diff'])){$df = $_GET['diff'];}
if(isset($_GET['zipDir'])){$zipDir = $_GET['zipDir'];}
if(isset($_GET['siteDir'])){$siteDir = $_GET['siteDir'];}
if(isset($_GET['targetDirs'])){ $targetDirs = explode(',',$_GET['targetDirs']); }
$diff 	= $df;
