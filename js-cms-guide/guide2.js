...
var CMS_GuideU = (function(){
	...
	function getGuideTag(_id,_s,_type){
		...
		if(_type == "dark"){
			return  '<span class="btn_guide_block _btn_guide_block_dark" data-id="'+_id+'"><i class="fa fa-lg fa-question-circle"></i> ' + _s + "</span>" 
		} else if(_type == "header"){
			return  '<span class="btn_guide_block _btn_guide_block_header _big" data-id="'+_id+'"><i class="fa fa-lg fa-question-circle"></i> ' + _s + "</span>" 
		} else if(_type == "big"){
			return  '<span class="btn_guide_block _btn_guide_block_light _big" data-id="'+_id+'"><i class="fa fa-lg fa-question-circle"></i> ' + _s + "</span>" 
		} else if(_type == "blue"){
			return  '<span class="btn_guide_block _btn_guide_block_light _blue" data-id="'+_id+'"><i class="fa fa-lg fa-question-circle"></i> ' + _s + "</span>" 
		} else{	
			return  '<span class="btn_guide_block _btn_guide_block_light" data-id="'+_id+'"><i class="fa fa-lg fa-question-circle"></i> ' + _s + "</span>" 
		}
	}
